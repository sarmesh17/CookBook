    ...
    Column(modifier = Modifier.fillMaxSize()) {
        Box {
            ...
            Row(
                ...
                Text(text = "Sign Up", fontSize = 20.sp, color = Color.White, fontFamily = poppinsFontFamily, modifier = Modifier.clickable { navController.navigate(Routes.CreateAccountScreen) })
            }
        }
        Row(
            modifier = Modifier
